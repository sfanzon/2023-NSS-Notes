...
The aim of this chapter is to rigorously introduce the set of **real numbers**, which is denoted by $\R$. But what do we mean by real numbers? To start our discussion, introduce the set of natural numbers (or non-negative integers)
$$
\N = \{0,1,2,3,4,5,\dots\}
$$
...
$$ {#eq-contradiction-root-2-4}
    ...
    > Wait. Why is the above true? As you know, even numbers are
    $$
    ...
    $$
    for some $p \in \N$.  
    Now let us see what happens if we take the square of an even number $m = 2p$
    $$
...
\sqrt{2} \in \Q \,.
$$
Hence the above is **false**, and so 
$$
\sqrt{2} \notin \Q \,
$$
ending the proof.
