...
We have defined $\R$ as a complete ordered field. This was done axiomatically and in a non 
constructive way. What happens now to the sets $\N, \Z, \Q$? Are they well defined? 
Does it still hold that
$$
\N \,, \Z \,, \Q \, \subset \R \,?
$$
The definitions that we gave in Chapter 1 for $\N, \Z$ and $\Q$ are 
not related to the system of real numbers $\R$ we just introduced. To overcome this problem, we will have to define new sets
$$
{\N}_{\R}, \,\, {\Z}_{\R}\,, \,\, {\Q}_{\R}
$$ 
from scracth, starting from the axioms of $\R$. We are using a new font to distinguish
...
- For every pair of numbers $a,b \in \R$ with $a<b$, there exists $r \in \Q$ such that
$$
a < r < b \,.
$$
