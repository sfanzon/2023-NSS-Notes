...
\left(  \frac{n}{n-1}  \right)^n  \left(  \frac{n}{n-1}  \right) \,. 
$$
Dividing by the term $(n/(n-1))^n$ we obtain
$$
\left(  \frac{n^2 - 1}{n^2}  \right)^n \geq 1 - \frac1n \,,
$$
which is equivalent to
$$
\left(  1 - \frac{1}{n^2}  \right)^n \geq 1 - \frac1n \,, \forall \, n \in \N \,.
$${#eq-proof-euler-1}
...
$$
To prove the above, we rewrite it as
$$
\left(   1  + \frac{1}{n-1} \right)^{n} \geq
\left(   1  + \frac{1}{n} \right)^{n+1} \,.
$$
Expanding the fractions, the above is equivalent to
$$
\left(   \frac{n}{n-1} \right)^{n} \geq
\left(   \frac{n+1}{n} \right)^{n} \left(   \frac{n+1}{n} \right) \,.
$$
Dividing by $((n+1)/n)^n$ we get
$$
...
$$
|a_n| < \frac{\pi}{2} \, \quad \forall \, n \geq N \,.
$$
Therefore, by inequality (@eq-limiti-notevoli-1), we get
$$
...
$$
\cos(x) < \frac{\sin(x)}{x} < 1  \,, \quad \forall \, x \in \left[-\frac{\pi}{2}, 0 \right] \,.
$$
Thus
$$
\cos(x) < \frac{\sin(x)}{x} < 1  \,, \quad \forall  \, x \in \left[-\frac{\pi}{2}, \frac{\pi}{2} \right] \,.
$$
Since $a_n \to 0$, there exists $N \in \N$ such that
$$
|a_n| < \frac{\pi}{2} \, \quad \forall \, n \geq N \,.
