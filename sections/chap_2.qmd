...
2. Transitive: If $A \subset B$ and $B \subset C$, then by definition of inclusion $A \subset C$.
...
*Step 2. Proof of the second inequality in (@eq-triangle-inequality).*  
