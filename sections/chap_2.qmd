...
![Interval $(a,b)$](/images/interval_1.png){#fig-interval-1 width=70%}

![Interval $[a,b]$](/images/interval_2.png){#fig-interval-2 width=70%}

![Interval $(a,\infty)$](/images/interval_3.png){#fig-interval-3 width=70%}

![Interval $(-\infty,b]$](/images/interval_4.png){#fig-interval-4 width=70%}
...
![Vectors $x$ and $y$](/images/triangle_ineq_1.png){#fig-triangle-ineq-1 width=30%}


![Summing the vectors $x$ and $y$. The triangle inequality relates the length of $x+y$ to the length of $x$ and $y$](/images/triangle_ineq_2.png){#fig-triangle-ineq-2 width=45%}
