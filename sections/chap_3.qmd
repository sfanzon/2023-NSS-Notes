...
A crucial definition in Analysis is the one of supremum or infimum of a set. 
...
In this section we introduce the notion of **Completeness**. We will see that completeness is equivalent to the **Cut Property**. 
...
::: Remark
Since **Cut Property** and **Axiom of Completeness** are equivalent, one can replace the Cut Property at Point 5 with:  

5. The **Axiom of Completeness** holds:
    - (AC) STATEMENT HERE
:::
