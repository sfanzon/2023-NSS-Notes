...
- $M \subset {\Z}_{\R}$:  Suppose $m \in M$. We have 3 cases:
  ...
  In all 3 cases we have shown that $m \in {\Z}_{\R}$, proving that $M \subset {\Z}_{\R}$.

- ${\Z}_{\R} \subset M$: Let $z \in {\Z}_{\R}$. Then $z = m - n$ for some $n,m \in {\N}_{\R}$. We have 3 cases:
