...
- $(K,+,\cdot)$ satisfying (A1)-(A3), (M1)-(M3), (AM) is a **field** 
- $(K,+,\cdot, \geq)$ satisfying (A1)-(A3), (M1)-(M3), (O1)-(O4) ,(AM), (AO), (MO) is an **ordered field**
...
- $(\R,+, \cdot,\geq)$ is an **ordered field** in which the **Cut Property** (CP) or **Axiom of Completeness** (AC) hold
:::
...
Now that we established the axiomatic definition of the Real Numbers $\R$, let us investigate some of their properies. 
