...
> Indeed, we have $B \neq \emptyset$, since $A$ is bounded above. Further, we have $B \neq K$: this is because otherwise every point of $K$ would be an upper bound of $A$. Thus $A$ would be empty. Hence 
$$
B \neq \emptyset \,, \quad B \neq K \,,
$$
